  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4">
      ...
      >
        ...
        <span className={`font-medium ${value === 'building' ? 'text-[#db4a2b]' : 'text-gray-700'}`}>Building</span>
      </button>
      ...
      >
        <Home className={`h-8 w-8 mb-2 ${value === 'both' ? 'text-[#db4a2b]' : 'text-gray-600'}`} />
        <span className={`font-medium ${value === 'both' ? 'text-[#db4a2b]' : 'text-gray-700'}`}>
          Land & Building
        </span>
      </button>
    </div>
